...
public class DbTest5RecMove2 extends JFrame implements ActionListener{
	...
	Connection conn;
	Statement stmt; // 문자열 더하기만 되서 해킹에 취약해
	ResultSet rs;
	
	
	public DbTest5RecMove2() {
		super("레코드 이동");
	...
	private void accDb() {
		try {
			...
			stmt = conn.createStatement(
					...
					ResultSet.CONCUR_READ_ONLY); // 이걸적어야지 하나하나씩 넘어감
