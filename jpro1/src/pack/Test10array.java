...
public class Test10array {
	...
	public static void main(String[] args) {
		// 배열(array) : 성격과 크기가 일치라는 복수 개의 기억장소에 대해
		...
		//ar[5] = 50; // ArrayIndexOutOfBoundsException : 런타임 에러
		int a =4, b=4 ;
		...
		int tot = 0;
		for(int i=0; i <ar2.length; i++) {
			System.out.print(ar2[i] + " "); //출력 : 1 2 3 4 5
			tot += ar2[i];
		}
		System.out.println("ar2 요소 값 총합 : " + tot); // ar2 요소 값 총합 : 15
