...
// 예외처리 : 키보드, 파일 처리, 네트워크처리, DB연동 처리 등 외부와 접속을 통한 프로그래밍 작업 중
// 예상치 못한 에러가 발생할 수 있는데 이와 같은 경우 주로 사용한다.
// try ~ catch 구문을 사용
...
public class Ex26Try {
	...
	public void testMethod() {
		...
		try {
			...
			System.out.println("testMehod 오류 :" + e);
		}
	}
