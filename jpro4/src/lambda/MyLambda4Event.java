...
/*		for(Jikwon j:jikwons) {
		...
		//accept(Jikwon j) {System.out.println(j.bunho + " " + j.irum);}
		// 아래쓰인게 위에 의미임
		// 람다쓰면서 foreach 사용 : arraylist 
		...
		Collections.sort(jikwons, new Comparator<Jikwon>() {
			public int compare(Jikwon o1, Jikwon o2) {
				return o1.bunho -o2.bunho; // 람다 없이 오름차순으로 정렬 :Collections.sort
			};
		});
		...
		System.out.println("람다사용해서 정렬 후 2: ");
