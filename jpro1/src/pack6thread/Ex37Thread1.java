...
public class Ex37Thread1 extends Thread{
	...
	public static void main(String[] args) {
		...
		//	Ex37Thread1 th1 = new Ex37Thread1();
			...
			th1.start(); //start가 run을 실행하도록 함. 스레드를 사용한 경우
		//	Ex37Thread1 th2 = new Ex37Thread1();
			...
			th2.setPriority(MAX_PRIORITY); // 스레드 스케줄러에게 우선 순위를 요청함
			
			th1.join(); // th1 thread가 종료될 때까지 main 스레드 종료를 대기시킴
		//	th2.join();
			
			th1.yield(); // 다른 스레드의 수행 요청이 들어오면 현재 스레드의 수행을 일시정지함
